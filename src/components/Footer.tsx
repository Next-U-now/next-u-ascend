...
const socials = [
  ...
  {
    name: "YouTube",
    url: "https://youtube.com/@nextu_now-k7c?si=DCskwlpfGAF3O7e5",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
      ...
      <div className="grid md:grid-cols-3 gap-12 mb-12">
        ...
        <div>
          ...
          <div className="space-y-3">
            <a href="tel:+593983949211" className="flex items-center gap-3 text-sm text-muted-foreground hover:text-foreground transition-colors">
