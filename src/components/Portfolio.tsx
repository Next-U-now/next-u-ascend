        ...
        >
          <div className="flex flex-col md:flex-row items-center gap-8 p-8 md:p-12">
            ...
            <div className="text-center md:text-left flex-1">
              ...
              <h3 className="text-3xl md:text-4xl font-extrabold tracking-tight text-gradient neon-text mb-2">{clients[0].name}</h3>
              <p className="text-muted-foreground mb-4">Máquinas expendedoras inteligentes — promociona tu marca en espacios estratégicos con tecnología de vanguardia.</p>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
          {clients.slice(1).map((client, i) => (
            ...
            >
              ...
              <h3 className="text-lg md:text-2xl font-extrabold tracking-tight text-center text-gradient neon-text">
                {client.name}
              </h3>
            </div>
          ))}
